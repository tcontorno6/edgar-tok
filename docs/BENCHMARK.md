...
| pattern | n in eval | edgar-bpe-65536 | edgar-bpe-65536-norm* | edgar-bpe-65536-digits | edgar-bpe-65536-line | edgar-bpe-131072-line | gpt2 | qwen3 |
|---|---|---|---|---|---|---|---|---|
| dollar_amount | 70,876 | 3.89 | 3.89 | 1.72 | 3.07 | 2.91 | 3.97 | 5.89 |
| percentage | 27,380 | 3.09 | 3.09 | 1.34 | 2.8 | 2.53 | 3.09 | 5.03 |
| basis_points | 630 | 2.0 | 2.0 | 2.0 | 2.26 | 2.21 | 2.15 | 2.49 |
| cusip_like | 42 | 4.29 | 4.29 | 4.29 | 5.48 | 5.36 | 4.67 | 7.93 |
| rule_section_citation | 17,047 | 3.46 | 3.46 | 3.44 | 2.67 | 2.56 | 3.66 | 5.18 |
| section_symbol | 308 | 4.73 | 4.73 | 3.05 | 4.34 | 4.17 | 4.78 | 8.6 |
| big_number | 28,307 | 5.01 | 5.01 | 2.68 | 4.07 | 3.79 | 5.37 | 10.38 |

## Canonical examples (tokens)

| text | edgar-bpe-65536 | edgar-bpe-65536-norm* | edgar-bpe-65536-digits | edgar-bpe-65536-line | edgar-bpe-131072-line | gpt2 | qwen3 |
|---|---|---|---|---|---|---|---|
| `$1,234.56` | 6 | 6 | 2 | 5 | 4 | 6 | 9 |
| `$3,232,193` | 6 | 6 | 3 | 5 | 5 | 6 | 10 |
| `4.25%` | 4 | 4 | 1 | 3 | 3 | 4 | 6 |
| `150bps` | 2 | 2 | 2 | 3 | 3 | 2 | 5 |
| `88160R101` | 4 | 4 | 4 | 5 | 5 | 4 | 10 |
| `Rule 206(4)-1` | 6 | 6 | 6 | 5 | 5 | 6 | 9 |
| `§251(h)` | 5 | 5 | 5 | 4 | 4 | 5 | 6 |
| `Item 1A. Risk Factors` | 6 | 6 | 6 | 2 | 2 | 6 | 7 |
| `RevenueFromContractWithCustomerExcludingAssessedTax` | 9 | 9 | 9 | 12 | 12 | 10 | 10 |
| `basis points` | 2 | 2 | 2 | 2 | 2 | 2 | 2 |
| `EBITDA margin` | 2 | 2 | 2 | 3 | 3 | 4 | 4 |
| `the Company’s` | 4 | 3 | 4 | 2 | 2 | 5 | 3 |
